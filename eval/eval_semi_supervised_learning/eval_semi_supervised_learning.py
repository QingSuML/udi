...
"""
Mostly copy-paste from ibot repo:
https://github.com/bytedance/ibot/blob/main/evaluation/semi_supervised/eval_cls.py
"""
...
def get_args_parser():
    ...
    # Dataset parameters
    parser.add_argument('--data_path', default='/dataset/imageNet/', type=str,
                        help='dataset path')
